...
householdsRouter.route("/:household_id")
    .post(postNewUserToHousehold)
    .patch(patchHouseholdUsers)

householdsRouter.post("/", postNewHousehold)

householdsRouter.route("/:household_id/tasks")
    .get(getAllTasks)
...
householdsRouter.delete("/:household_id/users/:user_id", removeUserFromHousehold)
